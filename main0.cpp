...
void base_show_mptr(void) {
	...
	printf("mtd0 : 0x%llx 0x%llx 0x%llx 0x%llx 0x%llx.\n", ptr, mtd, 0xff, 0, 0, 0);
	mtd = base_get_mptr(1);
	printf("mtd1 : 0x%llx 0x%llx 0x%llx 0x%llx 0x%llx.\n", ptr, mtd, 0xff, 0, 0, 0);
	mtd = base_get_mptr(2);
	printf("mtd2 : 0x%llx 0x%llx 0x%llx 0x%llx 0x%llx.\n", ptr, mtd, 0xff, 0, 0, 0);
	mtd = base_get_mptr(3);
	printf("mtd3 : 0x%llx 0x%llx 0x%llx 0x%llx 0x%llx.\n", ptr, mtd, 0xff, 0, 0, 0);
	mtd = base_get_mptr(4);
	printf("mtd4 : 0x%llx 0x%llx 0x%llx 0x%llx 0x%llx.\n", ptr, mtd, 0xff, 0, 0, 0);
	seed = prv;
}
